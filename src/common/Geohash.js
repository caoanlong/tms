export default new function () {
    ...
    o.prototype = {
        ...
        if (e instanceof Array && null == a && (a = e[1], e = e[0]), e *= 1, a *= 1, e !== e) throw new Error(
                "Geohash.encode: lat must be a Number")
        if (a !== a) throw new Error("Geohash.encode: lng must be a Number")
        for (var i, s, c = e.toString().length - e.toFixed().length - 2, l = a.toString().length - e.toFixed()
                .length - 2, u = n(10, -t(c, l, 0)) / 2, d = new o, f = [], p = 180, h = !0, m = 0, g = 4; p >=
            u;) if (h ? (i = d.halfLng(), a > i ? (m |= 1 << g, d.minlng = i) : d.maxlng = i) : (i = d.halfLat(),
                e > i ? (m |= 1 << g, d.minlat = i) : d.maxlat = i), h = !h, g) g--;
            else {
        ...
        for (var c = new o, l = 90, u = 180, d = function (e, t, n) {
                var a = 1 << e;
                !(1 & e) ^ !(1 & n) ? a & t ? c.minlat = c.halfLat() : c.maxlat = c.halfLat() : a & t ? c.minlng =
                    c.halfLng() : c.maxlng = c.halfLng()
