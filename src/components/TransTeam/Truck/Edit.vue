<template>
	<div class="main-content" style="padding-left:200px">
		<el-form label-width="120px" size="mini" :model="truck" :rules="rules" ref="ruleForm" >
					...
					<div class="block-content">
						...
						<el-row :gutter="20">
							<el-col :span="12">
								...
								<el-form-item label="行驶证有效期从">
									<el-date-picker :picker-options="{ disabledDate: (curDate) => new Date() < curDate}" type="date" :clearable="false" value-format="timestamp" v-model="truck.driverLicBeginTime" style="width:100%">
									</el-date-picker>
								</el-form-item>
							</el-col>
							<el-col :span="12">
								<el-form-item label="行驶证有效期至">
									<el-date-picker :picker-options="{ disabledDate: (curDate) => new Date() > curDate}" type="date" :clearable="false" value-format="timestamp" v-model="truck.driverLicExpiresTime" style="width:100%">
									</el-date-picker>
								</el-form-item>
							</el-col>
						</el-row>
...
export default {
	...
	methods: {
		...
		handSelectPrimaryDriver(data) { this.truck.primaryDriver = data.supercargoID },
		handSelectSecondaryDriver(data) { this.truck.secondaryDriver = data.supercargoID },
