...
import Step1 from './components/Step-edit1'
import Step2 from './components/Step-edit2'
import Step3 from './components/Step-edit3'
import Step4 from './components/Step-edit4'
export default {
	data() {
		return {
			selectedTruck: {},
